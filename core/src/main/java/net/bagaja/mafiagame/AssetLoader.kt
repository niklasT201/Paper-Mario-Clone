...
object AssetLoader {
    ...
    fun loadGameSounds(soundManager: SoundManager) {
        ...
        load("CAR_LOCKED_V4", "cars/locked/car_locked_four.ogg")
        load("CAR_LOCKED_V5", "cars/locked/car_locked_five.ogg")
        load("CAR_LOCKED_V6", "cars/locked/car_locked_six.ogg")
        load("CAR_LOCKED_V7", "cars/locked/car_locked_seven.ogg")
        load("CAR_LOCKED_V8", "cars/locked/car_locked_eight.ogg")
        load("CAR_LOCKED_V9", "cars/locked/car_locked_nine.ogg")
        load("POLICE_CAR_LOCKED", "cars/locked/police_car_locked.ogg")
        ...
        soundManager.load(SoundManager.Effect.LOOT_DROP)
        soundManager.load(SoundManager.Effect.THROWABLE_WHOOSH)
