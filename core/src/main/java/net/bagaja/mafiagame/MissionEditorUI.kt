...
class MissionEditorUI(
    ...
    init {
        ...
        editorDetailsTable.add(startFadeInCheckbox).colspan(2).left().padTop(5f).row()
    ...
    private fun populateEditor(missionId: String) {
        ...
        startFadeOutCheckbox.isChecked = mission.startFadeOut
        startFadeInCheckbox.isChecked = mission.startFadeIn
    ...
    private fun applyChanges() {
        ...
        mission.startFadeOut = startFadeOutCheckbox.isChecked
        mission.startFadeIn = startFadeInCheckbox.isChecked
